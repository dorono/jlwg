          ...
          <?php if($data["portfolio_filterable"]){ ?>
            ...
            <div id="portfolio-filter">
              ...
              <ul id="filters">
                ...
                <li><a href="#" data-filter="*"><?php _e('All', 'reboot'); ?></a></li><?php 
                  $categories = get_categories(array('type' => 'post', 'taxonomy' => 'project-type')); 
                  foreach($categories as $category) {
                  $group = $category->slug;
                    echo "<li><a href='#' data-filter='.$group'>".$category->cat_name."</a></li>";
                  }
            ...
            <div class="span12">
              <div id="portfolio-items" class="row">
                ...
                foreach ( (array) $cur_terms as $cur_term ) {   
                  ...
                  <div class="media-box span3 block <?php echo strtolower($cur_term->slug); ?>"data-filter=""> 
                ...
                foreach ( (array) $cur_terms as $cur_term ) {   
                  ...
                  <div class="media-box span6 block <?php echo strtolower($cur_term->slug); ?>"data-filter=""> 
